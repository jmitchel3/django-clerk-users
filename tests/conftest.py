...
# Loading an ignored example .env is opt-in so normal unit test runs do not
# accidentally use live Clerk credentials from a local demo app.
_env_file = (
...
_load_example_env = os.environ.get("DJANGO_CLERK_USERS_LOAD_EXAMPLE_ENV") == "1"

if _load_example_env and _env_file.exists():
    try:
